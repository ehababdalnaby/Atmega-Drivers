...
typedef enum{PB0=8,PB1,PB2,PB3,PB4,PB5,PB6,PB7}PortB;
typedef enum{PC0=16,PC1,PC2,PC3,PC4,PC5,PC6,PC7}PortC;
typedef enum{PD0=24,PD1,PD2,PD3,PD4,PD5,PD6,PD7}PortD;
...
void allPinsDirection(volatile u8* port, u8 direction);
